  ...
  return (
    <>
      <section className=" px-4  sm:px-6 lg:px-8 ">
        <BackgroundLines className="mx-auto flex w-full max-w-7xl flex-col items-center justify-center gap-2 lg:flex-row">
          <section className="flex w-full flex-col gap-4">
            ...
            <section className="mx-auto flex w-fit flex-col gap-2 lg:mx-0">
